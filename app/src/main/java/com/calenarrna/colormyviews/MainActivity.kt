package com.calenarrna.colormyviews
...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            R.id.green_button -> box_three_text.setBackgroundResource(R.color.myGreen)
            R.id.yellow_button -> box_four_text.setBackgroundResource(R.color.myYellow)
            R.id.red_button -> box_five_text.setBackgroundResource(R.color.myRed)
            else -> view.setBackgroundResource(R.drawable.golden_compass)
        }
    }
